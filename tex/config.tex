...
% Aliases
\newcommand{\faculty}{}
\newcommand{\client}{Hack The Box}
\newcommand{\cptc}{Hack The Box}
\newcommand{\teamname}{Darccau}
...
\teammember{darccau}{darccau@gmail.com}
}
...
\newcommand{\institutionlogo}{images/general/htb.png}
